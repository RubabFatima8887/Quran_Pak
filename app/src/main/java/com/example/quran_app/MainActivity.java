...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<String> surahsName = new ArrayList<String>();
    ArrayList<String> surahsAyats = new ArrayList<String>();
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < englishSurahNames.length; i++) {
            surahsName.add(englishSurahNames[i]);
        }
        ArrayAdapter<String> arrayAdapter;
        arrayAdapter = new ArrayAdapter<String>
                (this, android.R.layout.simple_list_item_1, surahsName);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                in.putExtra("SurahName", surahsName.get(i));
                startActivity(in);
            }
        });
